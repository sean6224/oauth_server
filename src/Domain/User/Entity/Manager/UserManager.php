 ...
 * Creates new user and triggers the `UserWasCreated` domain event after checking email's uniqueness.
 ...
 * - `logOut()`: Logs out the user and triggers the `UserLogOut` domain event.
 * - `changeEmail(Email $email, CustomerEmailUniquenessCheckerInterface $customerEmailUniquenessChecker)`:
